...
from model.backbones.resnet_ibn_a import resnet101_ibn_a, resnet50_ibn_a
...
class MGN(nn.Module):
    def __init__(self, num_classes):
        ...
        resnet = resnet101_ibn_a(last_stride=1)
        resnet.load_param('/home1/sunziruo/IBN/resnet101_ibn_a.pth')
        ...
        pool2d = nn.AvgPool2d
        self.maxpool_zg_p1 = pool2d(kernel_size=(9, 9))
        self.maxpool_zg_p2 = pool2d(kernel_size=(18, 18))
        self.maxpool_zg_p3 = pool2d(kernel_size=(18, 18))
        self.maxpool_zp2 = pool2d(kernel_size=(9, 18))
        self.maxpool_zp3 = pool2d(kernel_size=(6, 18))
