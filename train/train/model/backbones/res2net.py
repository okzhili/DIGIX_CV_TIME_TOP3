...
class Res2Net(nn.Module):
    ...
    def __init__(self, last_stride, block, layers, baseWidth=26, scale=4, num_classes=1000):
        self.inplanes = 64
...
def res2net50_v1b(last_stride=1, pretrained=False, **kwargs):
...
def res2net101_v1b(last_stride=1,pretrained=False, **kwargs):
    """Constructs a Res2Net-50_v1b_26w_4s model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = Res2Net(last_stride,Bottle2neck, [3, 4, 23, 3], baseWidth=26, scale=4, **kwargs)
    if pretrained:
