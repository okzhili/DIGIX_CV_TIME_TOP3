...
def regnety_800mf(last_stride, **kwargs):
    regnet_cfg.merge_from_file('/home/lab3/bi/0731/dmt/model/backbones/regnet/RegNetY-800MF_dds_8gpu.yaml')
    return RegNet(last_stride)


def regnety_1600mf(last_stride, **kwargs):
    regnet_cfg.merge_from_file('/home/lab3/bi/0731/dmt/model/backbones/regnet/RegNetY-1.6GF_dds_8gpu.yaml')
    return RegNet(last_stride)


def regnety_3200mf(last_stride, **kwargs):
    regnet_cfg.merge_from_file('/home/lab3/bi/0731/dmt/model/backbones/regnet/RegNetY-3.2GF_dds_8gpu.yaml')
    return RegNet(last_stride)
