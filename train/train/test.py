...
from model import make_model,make_model_infer,make_model_layer4,make_model_layer34
...
if __name__ == "__main__":
    ...
    # torch.save(model.half().state_dict(), os.path.join(cfg.OUTPUT_DIR, 'infer.pth'))
