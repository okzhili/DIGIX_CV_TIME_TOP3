...
from utils.post_process import database_aug,database_aug_after_rerank,pca_whiten
...
def eval_func(distmat, q_pids, g_pids, q_camids, g_camids, max_rank=50):
    ...
    if test_flag:
        ...
        gallery_img_list = []
        with open("/home/lab3/bi/0716/Veri/ai_city/tools/aicity20/crop_gallery_B.txt", "r") as f:
            data = f.read()
            data = data.split('\n')
            for img in data:
                gallery_img_list.append(img.split(',')[0][-20:])
        query_img_list = []
        with open("/home/lab3/bi/0716/Veri/ai_city/tools/aicity20/crop_query_B.txt", "r") as f:
            data = f.read()
            data = data.split('\n')
            for img in data:
                query_img_list.append(img.split(',')[0][-20:])

        # 提交文件
        with open("/home/lab3/bi/0731/output/submission.csv", "w+") as f:
            pass
        with open("/home/lab3/bi/0731/output/submission.csv", "a+") as f:
...
class R1_mAP_eval():
    ...
    def compute(self):  # called after each epoch
        ...
        self.camids = np.load('/home/lab3/bi/0816_MGN/dmt/utils/ibn50_camid.npy')
...
# R1_mAP_eval(num_query=41574).compute()


class R1_mAP():
    def __init__(self, num_query, max_rank=50, feat_norm=True, reranking=True, reranking_track=False):
