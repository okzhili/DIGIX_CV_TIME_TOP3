...
def eval_func(indices, q_pids, g_pids, q_camids, g_camids, max_rank=50):
    ...
    print("total_camids",total_camids)
    ...
    for q_idx in range(num_q):
        ...
        else: # for others like market1501 #Veri (类别相同，并且摄像头一样会被删除)
            remove = (g_pids[order] == q_pid) & (g_camids[order] == q_camid)
...
class evaluator(object):
    ...
    def compute(self):
        ...
        if test_flag:
            ...
            #提交文件
            with open("/home/lab3/bi/0716/Veri/ai_city/submission.csv", "a+") as f:
