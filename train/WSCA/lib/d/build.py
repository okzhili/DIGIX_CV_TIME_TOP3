...
from .d1 import init_dataset, ImageDataset, BaseImageDataset, apply_id_bias
...
#训练集打乱顺序
#dataset包含BaseImageDataset()
#num class由num_train_pids数量决定
def make_data_loader(cfg, shuffle_train=True):
    ...
    print(cfg.DATASETS.TEST,isinstance(cfg.DATASETS.TEST, str))
    # LOAD VALIDATE
    ...
    #train_collate_fn   如何选择取样本

    if cfg.DATALOADER.SAMPLER == 'softmax':
        print("softmax triplet")
